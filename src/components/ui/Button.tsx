export const Button = ({
  ...
  const variants = {
    primary: "bg-blue-600 hover:bg-blue-700 text-white shadow-sm shadow-blue-500/10 active:bg-blue-800",
    outline:
      "border border-slate-250 bg-white hover:bg-slate-50 text-slate-700 hover:text-slate-900 shadow-sm",
    success: "bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm shadow-emerald-500/10 active:bg-emerald-800",
    danger: "bg-rose-600 hover:bg-rose-700 text-white shadow-sm shadow-rose-500/10 active:bg-rose-800",
  };
  return (
    <button
      onClick={onClick}
