...
export const DEFAULT_TARGET_DEFENSE_DATA: TargetDefenseData = {
...
export const DEFAULT_SMOKE_TIME: SmokeTimeRange = {
  fromH: "06",
  fromM: "00",
  toH: "06",
  toM: "15",
...
export const DEFAULT_SMOKE_METHOD_DATA: SmokeMethodData = {
  lineType: "Thẳng",
  lineRole: "Chính",
  bufferColor: "none",
  vehicleSide: "right",
...
export const DEFAULT_BATTLEFIELD_DATA: BattlefieldData = {
  firePoints: {
    rawCoords: null,
    distance: "",
    direction: "Bắc",
...
export const useSimulationStore = create<SimulationStoreState>((set, get) => ({
  ...
  targetDefenseData: { ...DEFAULT_TARGET_DEFENSE_DATA },
  smokeTime: { ...DEFAULT_SMOKE_TIME },
  smokeMethodData: { ...DEFAULT_SMOKE_METHOD_DATA },
  selectedVehicles: [],
  vehicleConfigs: {},
  originalVehicleConfigs: {},
  battlefieldData: { ...DEFAULT_BATTLEFIELD_DATA },
  battlefieldScale: 1,
